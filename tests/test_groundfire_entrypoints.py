...
class GroundfireEntrypointTests(unittest.TestCase):
    ...
    def test_client_main_uses_classic_local_by_default(self):
        calls = []
        ...
        class ClientStub:
            ...
            def connect(self, host, port, *, player_name="Player"):
                calls.append(("connect", host, port, player_name))
                return None
    ...
    def test_client_main_connect_uses_secure_backend_configuration(self):
        created = []
        calls = []
        ...
        self.assertEqual(created[0]["network_backend"], "mpgameserver")
    ...
    def test_server_main_uses_secure_backend_configuration(self):
        created = []
        calls = []
