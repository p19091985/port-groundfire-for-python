@echo off
setlocal
REM Script to run the standalone Groundfire dedicated server UI using the project's virtual environment on Windows.
...
"%VENV_PYTHON%" -m interface_net.server.demo
