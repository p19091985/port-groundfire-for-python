...
"$GODOT_BIN" --headless --path "$GODOT_PROJECT_DIR" --import
"$GODOT_BIN" --headless --path "$GODOT_PROJECT_DIR" --check-only --script res://scripts/platform_capabilities.gd
...
"$GODOT_BIN" --headless --path "$GODOT_PROJECT_DIR" --check-only --script res://scripts/weapon_inventory.gd
"$GODOT_BIN" --headless --path "$GODOT_PROJECT_DIR" --check-only --script res://scripts/local_match_hud.gd
"$GODOT_BIN" --headless --path "$GODOT_PROJECT_DIR" --check-only --script res://scripts/local_match.gd
"$GODOT_BIN" --headless --path "$GODOT_PROJECT_DIR" --check-only --script res://scripts/online_match.gd
