...
"$GODOT_BIN" --headless --path "$ROOT_DIR/godot" --script res://tests/network_adapter_protocol_check.gd
...
"$GODOT_BIN" --headless --path "$ROOT_DIR/godot" --script res://tests/test_weapon_inventory_ammo.gd
