...
class GameBootstrapper:
    ...
    def bootstrap(self, game):
        settings_path = self._project_root / "conf" / "options.ini"
        controls_path = self._project_root / "conf" / "controls.ini"

        game._settings = self._settings_loader(str(settings_path))
        ...
        game._controls_file = self._controls_file_factory(game._controls, str(controls_path))
