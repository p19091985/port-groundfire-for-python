...
class MainMenu(Menu):
    def __init__(self, game: 'Game'):
        ...
        self._start_button = TextButton(self, 0.0, -3.6, 0.7, "Start Game")
        self._find_servers_button = TextButton(self, 0.0, -4.6, 0.7, "Find Servers")
        self._options_button = TextButton(self, 0.0, -5.6, 0.7, "Options")
        self._quit_button = TextButton(self, 0.0, -6.6, 0.7, "Quit")
    ...
    def update(self, time: float) -> int:
        ...
        if self._find_servers_button.update():
            return GameState.SERVER_BROWSER_MENU
    ...
    def draw(self):
        ...
        self.draw_game_polygon([(-7.0, -7.1), (7.0, -7.1), (7.0, -3.05), (-7.0, -3.05)], (0, 0, 0, 128))

        btn_bg_color = (153, 76, 0, 255)
        self.draw_game_polygon([(-4.0, -4.0), (4.0, -4.0), (4.0, -3.2), (-4.0, -3.2)], btn_bg_color)
        self.draw_game_polygon([(-4.0, -5.0), (4.0, -5.0), (4.0, -4.2), (-4.0, -4.2)], btn_bg_color)
        self.draw_game_polygon([(-4.0, -6.0), (4.0, -6.0), (4.0, -5.2), (-4.0, -5.2)], btn_bg_color)
        self.draw_game_polygon([(-4.0, -7.0), (4.0, -7.0), (4.0, -6.2), (-4.0, -6.2)], btn_bg_color)
